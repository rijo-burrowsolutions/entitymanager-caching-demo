...
public static class CompanyListFreshEndpoint
{
    public static IEndpointRouteBuilder MapCompanyListFreshEndpoints(this IEndpointRouteBuilder app)
    {
        app.MapGet("/list-fresh", Handle)
            .WithName("GetCompaniesFresh");

        return app;
    }

    private static async Task<IResult> Handle(
        [AsParameters] GetCompanyListFreshQuery query,
